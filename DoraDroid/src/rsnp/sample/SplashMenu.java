...
public class SplashMenu extends Activity implements BTConnectable {
...
System.out.println("type2");            	
    ...
    public static void startRXEprogram(byte status) {
    	System.err.println("MindDroid:startRXE");
        if (status == 0x00) {
        ...
        public void handleMessage(Message myMessage) {
            switch (myMessage.getData().getInt("message")) {
                ...
                case BTCommunicator.STATE_SENDERROR:
                    ...
                    destroyBTCommunicator();
                    System.err.println("Minddroid handler received: STATE_CONNECTERROR/STATE_RECEIVEERROR/STATE_SENDERROR");
                    /*
                ...
                case BTCommunicator.VIBRATE_PHONE:
                    if (myBTCommunicator != null) {
                    	System.err.println("Minddroid: handler receive BTCommunicator.VIBRATE_PHONE");
